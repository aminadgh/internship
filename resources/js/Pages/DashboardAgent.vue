...
import { UserGroupIcon, ChatBubbleLeftRightIcon, SquaresPlusIcon } from '@heroicons/vue/24/outline';
...
<template>
  <AuthenticatedLayout>
    <div class="max-w-6xl mx-auto py-8">
      <h1 class="text-3xl font-bold mb-4 text-gray-800">Welcome, {{ user.name }}!</h1>
